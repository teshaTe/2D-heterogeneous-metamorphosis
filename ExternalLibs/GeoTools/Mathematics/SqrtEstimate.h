...
namespace gte
{
    ...
    public:
        ...
        // The input constraint is x >= 0.  Range reduction is used to
        // generate a value y in [0,1], call Degree(y), and combine the
        // output with the proper exponent to obtain the approximation.
        // For example,
        //   float x;  // x >= 0
